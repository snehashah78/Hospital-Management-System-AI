...
const Header = () => {
  return (
    ...
    md:px-10 lg:px-20'>
        {/* ------- LEFT SIDE ----------- */}
        <div className='md:w-1/2 flex flex-col items-start justify-center py-10 gap-4 
        m-auto md:py-[10vw] md:mb-[-30px]'>
            ...
            <div className='flex flex-col md:flex-row items-center gap-3 text-white text-sm font-light'>
                ...
                <p>
                    ...
                    <br className='hidden sm:block'/> schedule your appointment hustel-free.
                </p>
            </div>

            <a href="#speciality" className='flex items-center bg-white gap-2 px-8 py-3 rounded-full
